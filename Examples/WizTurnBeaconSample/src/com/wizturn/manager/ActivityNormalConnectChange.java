...
public class ActivityNormalConnectChange extends FragmentActivity implements 
	Observer, android.view.View.OnClickListener {
	private final String LOG_TAG = ActivityNormalConnectChange.class.getSimpleName();
